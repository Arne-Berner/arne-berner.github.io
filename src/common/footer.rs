...
pub fn SiteFooter() -> impl IntoView {
  ...
  <nav class="grid grid-flow-col gap-4">
                <a class="link link-hover" href="/vita">Vita</a>
                <a class="link link-hover" href="/photos">Photos</a>
                <a class="link link-hover" href="/showreel">Showreel</a>
                <a class="link link-hover" href="/audio">Audio</a>
