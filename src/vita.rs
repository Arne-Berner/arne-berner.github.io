...
fn Tabs() -> impl IntoView {
  ...
  <input type="radio" name="my_tabs_3" class="tab text-xl" aria-label="Film & Fernsehen" checked="checked" />
 <div class="tab-content bg-base-100 border-base-300 p-6"><FilmTimeline/></div>
  <input type="radio" name="my_tabs_3" class="tab text-xl" aria-label="Theater" />
 <div class="tab-content bg-base-100 border-base-300 p-6"><TheaterTimeline/></div>
  <input type="radio" name="my_tabs_3" class="tab text-xl" aria-label="Werbung & Diverses" />
 <div class="tab-content bg-base-100 border-base-300 p-6"><DiversTimeline/></div>
</div>
}
}
...
<ul class="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
  <li>
    ...
    <div class="timeline-start whitespace-pre mb-10 md:text-end">
...
Casting: - "
  ...
  <li>
    ...
    <div class="timeline-end whitespace-pre md:mb-10">
...
Theater: Kreuzgangspiele"
  ...
  <li>
    ...
    <div class="timeline-end md:whitespace-pre mb-10">
      <time class="font-mono italic">2019</time>
